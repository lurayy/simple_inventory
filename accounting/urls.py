...
urlpatterns = [
   ...
   path('ledger/entry/correction',views.update_ledger_entry),
   ...
   path('settings/get', views.get_accounting_settings),
   path('settings/update', views.update_accounting_settings)
]