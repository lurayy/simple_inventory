...
class GiftCardList extends Component {
    ...
    async popUp(id, uuid=0, fromUrl=false){
        if(!fromUrl){
            ...
            console.log("this.data", data_main)
            this.setState({
                ...this.state,
                'popUp':true,
                'giftCard':data_main['gift_cards'][0],
                'update':data_main['gift_cards'][0]
            })
        }
    }
    ...
    render() {
        ...
        <Grid item xm={6}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xm={6} md={6} > 
                <TextField required id="rate"  name="rate"  label="rate" defaultValue={this.state.update.rate} onChange={this.onChange} />
            ...
            <Grid container spacing={3}  alignItems='flex-end'>
                ...
                <Grid item xm={3} md={6}> 
                <Button variant="contained" color="secondary" onClick={() => {this.giftCard(this.state.update.id)}}>
                    Delete Discount
                </Button> 
               </Grid>
            </Grid>
