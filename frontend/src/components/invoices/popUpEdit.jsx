...
class PopUpEdit extends Component {
    ...
    async componentDidMount() {
        ...
        await getInvoiceStatus(JSON.stringify(request_json)).then(data => {
            console.log("Data of the invoice", data)
            if (data['status']) {
                this.setState({
                    ...this.state,
                    'status': data.data
        ...
        await getPaymentMethods(JSON.stringify(request_json)).then(data => {
            console.log(data)
            if (data['status']) {
                this.setState({ ...this.state, payment_methods: data.payment_methods })
            }
        })
    }
    ...
    closePaymentPopup = () => {
        this.setState({ ...this.state, showPaymentPopup: false })
    }

    closeDiscountPopup = () => {
        this.setState({ ...this.state, showDiscountPopup: false })
    }

    closeTaxPopup = () => {
        this.setState({ ...this.state, showTaxPopup: false })
    }
    ...
    render() {
        ...
        //popup for adding discounts
        const addPopupDiscount = (

            <Popup
                open={this.state.showDiscountPopup}
            ...
            >
                <div>
                    ...
                    <Button
                        ...
                        color="secondary"
                        size='small'
                        onClick={this.closeDiscountPopup}
                    >Done</Button>
                </div>
            </Popup>)
        ...
        //popup for adding taxes
        const addPopupTax = (

            <Popup
                open={this.state.showTaxPopup}
                closeOnDocumentClick
                onClose={this.closeTaxPopup}
            ><div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    <Button
                                        onClick={() => {
                                            this.update_table(0, true);
                                            //show the popup to show discounts modal
                                            this.setState({ ...this.state, showDiscountPopup: true })
                                        }}
                                        variant="contained"
                                        color="secondary"
                                        size='small'
                            ...
                            <tr>
                                ...
                                <td>
                                    <Button
                                        ...
                                        size='small'
                                        onClick={() => {
                                            this.update_table(0, false);
                                            //show the popup to show taxes modal
                                            this.setState({ ...this.state, showTaxPopup: true })
                                        }}
                                    >Apply New Tax</Button>
                                </td>
                            </tr>
                            <tr>
                                <td colSpan={3}>
        ...
        const customerPopup = (
            <Popup trigger={<Button variant="contained" color="primary">Change Customer</Button>} closeOnDocumentClick>
                <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <Button style={{ marginLeft: 20 }} variant="contained" color="primary" onClick={() => this.setState({ ...this.state, showPaymentPopup: true })}>Add Payment</Button>
                                    </td>
                                    <td>
...
export default withStyles(useStyles)(PopUpEdit)